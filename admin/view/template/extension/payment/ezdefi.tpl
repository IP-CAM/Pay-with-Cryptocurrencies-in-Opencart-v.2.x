...
<div id="content">
    ...
    <div class="container-fluid ezdefi-admin-content-box">
        ...
        <label class="ezdefi-btn-tab ezdefi-btn-exception-tab" for="ezdefi-exception-tab"> <?php echo $tab_exception ?> </label>
            ...
            <div id="modal-revert-order-exception" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer" style="text-align: center">
                            <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo $button_close ?></button>
                            <button type="button" class="btn btn-primary" id="btn-revert-order" data-url-delete="<?php echo $url_delete_exception ?>" data-url-add-order-history="<?php echo $url_add_order_history ?>">
                                <i class="fa fa-refresh fa-spin exception-loading-icon exception-loading-icon__revert"></i><?php echo $button_yes ?>
                            </button>
                        </div>
                    </div>
                </div>
